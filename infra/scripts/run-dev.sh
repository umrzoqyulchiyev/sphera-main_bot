...
export USE_MEDIAMTX="${USE_MEDIAMTX:-false}"
export MEDIAMTX_HOST="${MEDIAMTX_HOST:-localhost}"
export MEDIAMTX_RTMP_PORT="${MEDIAMTX_RTMP_PORT:-1935}"
export MEDIAMTX_PUBLISH_PASS="${MEDIAMTX_PUBLISH_PASS:-MediaMTXPass2025!}"
export MEDIAMTX_PUBLIC_URL="${MEDIAMTX_PUBLIC_URL:-http://localhost:8889}"
